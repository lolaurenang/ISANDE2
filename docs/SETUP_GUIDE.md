...
You should see six accounts, five service jobs and a batch of logs created.
Run `npm run seed:reset` if you ever want to wipe everything and start over.
...
If all seven steps behave, the system is installed correctly.
